										...
										<table class="basic-information-table">
											...
											<tbody>
												...
												<tr>
													...
													<td colspan="3">
														<input type="text" class="ng-pristine ng-untouched ng-valid"
															name="email" value="${resume.email }" />
													</td>
													<th>SNS</th>
													<td colspan="3">
														<input type="text" class="ng-pristine ng-untouched ng-valid"
															name="sns"  value="${resume.sns}" />
													</td>
												</tr>
												<tr>
													<th>주소</th>
													<td colspan="7">
														<input type="text" class="basic-info-addr ng-pristine ng-untouched ng-valid"
															name="address"  value="${resume.address }" />
													</td>
												</tr>
											</tbody>
										</table>
										...
										<table class="advantage-table">
											...
											<tbody>
												...
												<tr>
													<th>장애여부</th>
													<td colspan="3">
														<c:if test="${resume.handi eq 'true'}">
														<input type="radio" name="handi" value="true" checked="checked"
															class="ng-pristine ng-untouched ng-valid" />대상 <input
															type="radio" name="handi" value="false"
															class="ng-pristine ng-untouched ng-valid" />비대상
														</c:if>
														<c:if test="${resume.handi eq 'false'}">
														...
														<select class="ng-pristine ng-untouched ng-valid" name="militFinYear">
															<option value="">-</option>
																<c:forEach var="year" begin="0" end="63" step="1">
																	...
																	<c:if test="${resume.militFinYear ne year}">
																		<option value="${2017-year}"
																			class="ng-binding ng-scope">${2017-year}</option>
																	</c:if>
																</c:forEach>
												...
												<tr>
													<th>군별</th>
													<td>
														<input type="text" value="${resume.militKind}"
													...
													<td>
														<input type="text" class="ng-pristine ng-untouched ng-valid"
															name="militRank" value="${resume.militRank}" />
													</td>
												</tr>
											</tbody>
										</table>
									...
									<table data-category-number="" class="ng-scope highschool-table category-repeater">
										...
										<tbody>
											...
											<tr>
												...
												<td>
													<input type="text" class="ng-pristine ng-untouched ng-valid"
														name="highName" value="${resume.highName}" />
												</td>
												<th>분류</th>
												<td>
									...
									<table data-category-number="" class="ng-scope university-table category-repeater">
										...
										<tbody>
											...
											<tr>
												...
												<td>
													<input type="text" class="basic-info-addr ng-pristine ng-untouched ng-valid"
														name="univName" value="${resume.univName }" />
												</td>
												<th>분류</th>
												<td>
								...
								<div class="category-wrapper ng-scope" data-category="3">
									<table data-category-number="" class="ng-scope graduate-school-table category-repeater">
										...
										<tbody>
											...
											<tr>
												<th>학교명</th>
												<td><input type="text" class="basic-info-addr" name="graduName"
													value="${resume.graduName}" /></td>
												<th>분류</th>
												<td>
												...
												<td>
													<input class="gradu-score small-input-text ng-pristine ng-untouched ng-valid"
														type="text" name="graduScore" value="${resume.graduScore }" /> &nbsp;/&nbsp;
													<select class="ng-pristine ng-untouched ng-valid" >
														<option value="?" selected="selected"></option>
														<option value="string:0" label="4.0">4.0</option>
														<option value="string:1" label="4.3">4.3</option>
									...
									<table data-category-number="" class="ng-scope certificate-table category-repeater">
										...
										<tbody>
											<tr>
												...
												<td colspan="3">
													<input type="text" class="ng-pristine ng-untouched ng-valid"
														name="licenName" value="${resume.licenName }" />
												</td>
											</tr>
											<tr>
												<th>발행처/기관</th>
												<td>
													<input type="text" class="ng-pristine ng-untouched ng-valid"
														name="licenInsti" value="${resume.licenInsti }" />
												</td>
												<th>등급</th>
												<td>
													<input type="text" class="ng-pristine ng-untouched ng-valid"
														name="licenGrad" value="${resume.licenGrad }" />
												</td>
											</tr>
										</tbody>
									</table>
									...
									<table data-category-number="" class="ng-scope career-table category-repeater">
										...
										<tbody>
											<tr>
												...
												<td>
													<input type="text" class="ng-pristine ng-untouched ng-valid"
														name="jobName" value="${resume.jobName }" />
												</td>
												<th>기간</th>
												<td>
											...
											<tr>
												...
												<td>
													<input type="text" class="ng-pristine ng-untouched ng-valid"
														name="jobRank" value="${resume.jobRank}" />
												</td>
												<th>부서</th>
												<td>
													<input type="text" class="ng-pristine ng-untouched ng-valid"
														name="jobDept" value="${resume.jobDept }" />
												</td>
											</tr>
											<tr class="assignment">
												<th>담당업무</th>
									...
									<table data-category-number="" class="ng-scope language-table category-repeater">
										...
										<tbody>
											<tr>
												...
												<td>
													<input type="text" class="ng-pristine ng-untouched ng-valid"
														name="langName" value="${resume.langName }" />
												</td>
												<th>시험명</th>
												<td>
													<input type="text" class="ng-pristine ng-untouched ng-valid"
														name="langTest" value="${resume.langTest }" />
												</td>
											</tr>
											<tr>
												<th>점수/등급</th>
												<td>
													<input type="text" class="ng-pristine ng-untouched ng-valid"
														name="langScore" value="${resume.langScore }" />
												</td>
												<th>취득일</th>
												<td>
									...
									<table data-category-number="" class="ng-scope award-table category-repeater">
										...
										<tbody>
											<tr>
												...
												<td>
													<input type="text" class="ng-pristine ng-untouched ng-valid"
														name="awardName" value="${resume.awardName }" />
												</td>
												<th>수상내용</th>
												<td>
													<input type="text" class="ng-pristine ng-untouched ng-valid"
														name="awardContent" value="${resume.awardContent }" />
												</td>
											</tr>
											<tr>
												<th>수여기관</th>
												<td>
													<input type="text" class="ng-pristine ng-untouched ng-valid"
														name="awardInsti" value="${resume.awardInsti }" />
												</td>
												<th>수상일</th>
												<td>
									...
									<table data-category-number="" class="ng-scope abroad-table category-repeater">
										...
										<tbody>
											<tr>
												...
												<td>
													<input type="text" class="ng-pristine ng-untouched ng-valid"
														name="abroadNation" value="${resume.abroadNation }" />
												</td>
												<th>기관</th>
												<td>
													<input type="text" class="ng-pristine ng-untouched ng-valid"
														name="abroadInsti" value="${resume.abroadInsti}" />
												</td>
											</tr>
											<tr class="objective">
												<th>목적 및 내용</th>
